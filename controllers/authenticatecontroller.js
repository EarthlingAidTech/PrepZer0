...
//       const verificationUrl = `https://localhost/authenticate/verify/${randurl}`;
...
exports.signupcontrol = async (req, res) => {
  try {
    ...
    // Create verification URL
    const verificationUrl = `https://prepzer0.co.in/authenticate/verify/${randurl}`;
